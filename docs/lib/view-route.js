import { getUnlocalizedLocationPath } from "./i18n.js";
...
export const handlePopState = (e) => {
    routerEvents.dispatchEvent(new PopStateEvent('popstate', { state: 'nav-back' }));
}
...
export const matchesRoute = (path, exact) => {
    ...
    const relativePath = getUnlocalizedLocationPath();
    return regex.exec(relativePath);
}
